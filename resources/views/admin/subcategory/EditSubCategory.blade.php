        ...
        $('#edit-SubCategory').click(function(e) {
            ...
            $.ajax({
                ...
                error: function(error) {
                    document.getElementById('SubcategoryNameEditError').style.display =
                        "none";
                    document.getElementById('CategoryIdEditError').style.display = "none";
                    document.getElementById('SubcategorySlugEditError').style.display =
                        "none";
                    if (error.responseJSON.errors.subcategory_name) {
                        ...
                        if (error.responseJSON.errors.subcategory_name[0]) {
                            ...
                            errMsg.textContent = error.responseJSON.errors.subcategory_name[
                                0];
                        }
                    }
