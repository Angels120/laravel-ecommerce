...
@section('container')
                            ...
                            <div class="col-sm-auto">
                                <div>
                                    <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal"
                                        id="create-btn" data-bs-target="#AddAdminUser"><i
    ...
    <!--end modal -->
    @include('admin.users.adminuser.EditAdmin')
    @include('admin.users.adminuser.AddAdmin')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.data-table').on("click", ".delete", function() {
                ...
                const deleteUrl = "{{ route('admin.user.delete', ['id' => ':id']) }}";
