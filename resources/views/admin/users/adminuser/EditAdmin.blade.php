            ...
            <div class="modal-body">
                <form action="#" method="post" id="Edit_admin_form">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="Editadmin_name" class="control-label mb-1">Admin Name<span
                        ...
                        <div class="mb-3">
                            <label for="Editusername" class="control-label mb-1">UserName<span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="form-check">
                        ...
                        <div class="modal-footer">
                            <div class="hstack gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-success" id="edit-admin">Add Admin User</button>
                            </div>
                        </div>
                        </div>
                </form>
...
<script>
    $(document).ready(function() {
        $('#edit-admin').click(function(e) {
            ...
            e.preventDefault();
            var data = $('#Edit_admin_form').serialize();
            $.ajax({
                type: 'POST',
                ...
                error: function(error) {
                    ...
                    document.getElementById('EditAdminNameError').style.display = "none";
                    ...
                    if (error.responseJSON.errors.name) {
                        ...
                        var errMsg = document.getElementById('EditAdminNameError');
