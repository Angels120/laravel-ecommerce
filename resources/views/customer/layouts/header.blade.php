    ...
    <div class="layout-width">
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{route('home.page')}}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('admin_asset/images/logos/webmart-light.svg') }}"  alt="" height="64">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('admin_asset/images/logos/webmart-light.svg') }}" alt="" height="64">
                        </span>
                    ...
                    <a href="{{route('home.page')}}" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ asset('admin_asset/images/logos/webmart-dark.svg') }}" alt="" height="64">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('admin_asset/images/logos/webmart-dark.svg') }}" alt="" height="64">
                        </span>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <a href="{{route('register')}}" class="btn btn-icon btn-topbar btn-ghost-secondary " data-bs-toggle="tooltip" data-bs-placement="bottom" title="Log In">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" >
                        <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Layouts <span class="m-2"><i class="ri-arrow-down-s-line"></i></span>
                    </a>
