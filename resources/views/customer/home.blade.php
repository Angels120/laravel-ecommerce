            ...
            <div class="px-0 mb-4">
                <div id="ProductSpecialEvent" class="carousel slide">
                    <div class="carousel-indicators">
                      <button type="button" data-bs-target="#ProductSpecialEvent" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                      <button type="button" data-bs-target="#ProductSpecialEvent" data-bs-slide-to="1" aria-label="Slide 2"></button>
                      <button type="button" data-bs-target="#ProductSpecialEvent" data-bs-slide-to="2" aria-label="Slide 3"></button>
                    </div>
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="https://images.unsplash.com/photo-1545768076-cacd50c03728?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=740&ixid=MnwxfDB8MXxyYW5kb218MHx8bmF0dXJlLGNpdHl8fHx8fHwxNzA2Nzc4ODE1&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1600" class="d-block w-100" alt="...">
                      ...
                      <div class="carousel-item">
                        <img src="https://images.unsplash.com/photo-1613688570481-820ec84316f3?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=740&ixid=MnwxfDB8MXxyYW5kb218MHx8bmF0dXJlLHJpdmVyfHx8fHx8MTcwNjc3NzQ1Mg&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1600" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img src="https://images.unsplash.com/photo-1577945734821-2d35ecc2910e?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=740&ixid=MnwxfDB8MXxyYW5kb218MHx8c3VufHx8fHx8MTcwNjc3NzQ5NA&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1600"class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#ProductSpecialEvent" data-bs-slide="prev">
                      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                      <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#ProductSpecialEvent" data-bs-slide="next">
